# 🥊 Boxing — تنظيم الإشارات المرجعية بشكل هرمي
...
### تنظيم الإشارات المرجعية بشكل هرمي

> انقر ＋ لإنشاء أول صندوق كبير

> العربية README — canonical feature list and technical specs are in the [English README](README.md).

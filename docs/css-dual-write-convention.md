...
## Build Artifact Note (ADR-0011)

> **ntp/ntp.css is a build artifact — DO NOT edit or commit directly.**
> It is generated by build.mjs from 4 source files: base.css + settings.css + onboarding.css + conn.css.
> The A8 dual-write validator reads the concatenated source files, NOT ntp.css.
> ntp.css is in .gitignore and is regenerated on every build.
> Source files live in ntp/base.css, ntp/settings.css, ntp/onboarding.css, ntp/conn.css.

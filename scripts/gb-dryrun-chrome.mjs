 ...
 *   v2026.9.15 + pre-update snapshot), G6 (named human sign-off), the whole Firefox lane
...
const EXT = arg("ext", "D:/rel-2026.9.20/chrome");
...
async function run() {
  ...
  rec("P0-manifest", manifest.version === "2026.9.20" && manifest.manifest_version === 3,
  ...
  const summary = {
    ...
    outOfScope: [
      ...
      "G4 upgrade install from v2026.9.15 + pre-update snapshot",

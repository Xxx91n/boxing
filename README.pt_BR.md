# 🥊 Boxing — organizar favoritos hierarquicamente
...
### organizar favoritos hierarquicamente

> Clique ＋ para criar primeira caixa grande

> Português (Brasil) README — canonical feature list and technical specs are in the [English README](README.md).

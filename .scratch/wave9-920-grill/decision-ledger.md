...
| D-005 | Q5 锐评 Top-5 剩余治理项是否进 9.20 | 全部进 | **三项全进**：①release-status 收敛单一状态块——删 §一 旧「不可发行」表、终谳预留块填 09-14 实测、旧 run 标 Superseded、页内规则「有且只有一个状态块」（文档票进 9.20）；②D-008 线性证明=过程红线——9.20 全部提交只在 a1acaaac 之上线性追加，导出工具做不到先改工具再开波；③豁免清零=9.20 G-A 出口条件——09-19 到期，前两轮 main CI 全绿按 105 判据撤 3 条 F 行；④静态门禁维持 D-002 姊妹票 | 负向：release-status 禁止只改标题不删矛盾表；D-008 第二次 root 导出即违规须停波；豁免不得无动作续期；grill 内不实施 | **revised**（2026-09-22 · followup Q3 调研：③「前两轮 main 全绿按 105 撤 3 条 F」在豁免**已过期**后不能作为独立路径；未修→禁用/删除，已修→才可撤账；原记录保留，改向见 wave9-920-followup D-003 呈报） |
| D-004 | Q4 B71–B78 逐项去向 | 全部调用进表，除了B76不需要更新 | **B71–B75+B77 全部进 9.20 实施表；B76 不做不更新；B78 维持已消**：①B71 N-101-06 zoom-dblclick 异源签名 — 立票进 9.20；②B72 N-106-01 innerclip setTimeout 预算 — **不再挂观察**，进 9.20 修；③B73 contrast-guard 串 pretest — 进 9.20；④B74 DESIGN Box/Zoom 偏差注记 — 进 9.20 文档；⑤B75 demo version 抽查 — 进表并入 D-003 升级 G-C 实施（同票 AC）；⑥B76 商店 listing 文案/截图 — **不更新、不立票**；⑦B77 CHANGELOG 9.15 扩写 — 进 9.20；⑧B78 维持已消；⑨3 条 active 豁免 09-19 到期 → 9.20 前两轮 CI 全绿按 105 判据撤账（实施出口，非 backlog 票） | 负向：B76 不进 agent 范围；B72 不得再以「观察未到期」推迟；B75 不得另开与 D-003 重复的抽查票；grill 内不实施 | **revised**（2026-09-22 · followup Q3 调研：⑨「到期后仍 active 等 2 绿再撤」缺「已修/未修」分叉，与票105硬到期+工业界「发行在即禁续期等证据」冲突；原记录保留，改向见 wave9-920-followup D-003 呈报） |

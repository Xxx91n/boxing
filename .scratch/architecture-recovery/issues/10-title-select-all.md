...
- [ ] 点击大/小盒子标题 → selection 字符串 === 当前标题文本
- [ ] 点击 crumb 标题同样全选（并获得焦点）
- [ ] 键入替换整名；Escape 还原；Enter blur 保存
- [ ] 不触发盒子拖拽；SEC-03 paste 纯文本保留
- [ ] Playwright selection 断言；`node --check ntp/render.js`

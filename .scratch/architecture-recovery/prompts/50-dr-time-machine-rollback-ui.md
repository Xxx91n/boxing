# 窗口启动器 — 50 Time Machine 一键回滚 UI + 恢复前安全快照

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/50-dr-time-machine-rollback-ui.md
- .scratch/architecture-recovery/issues/50-dr-time-machine-rollback-ui.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/50-dr-time-machine-rollback-ui-report.md

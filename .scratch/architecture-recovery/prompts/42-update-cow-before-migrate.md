# 窗口启动器 — 42 onInstalled(update) 先 COW 快照再迁移

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/42-update-cow-before-migrate.md
- .scratch/architecture-recovery/issues/42-update-cow-before-migrate.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/42-update-cow-before-migrate-report.md

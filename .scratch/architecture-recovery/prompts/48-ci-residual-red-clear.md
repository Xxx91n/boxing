# 窗口启动器 — 48 CI 残红清零（修绿优先+受控豁免）

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/48-ci-residual-red-clear.md
- .scratch/architecture-recovery/issues/48-ci-residual-red-clear.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/48-ci-residual-red-clear-report.md

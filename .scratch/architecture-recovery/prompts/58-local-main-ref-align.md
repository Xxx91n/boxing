# 窗口启动器 — 58 本地 main ref 与 origin/main 对齐（P2，待授权）

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/58-local-main-ref-align.md
- .scratch/architecture-recovery/issues/58-local-main-ref-align.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/58-local-main-ref-align-report.md

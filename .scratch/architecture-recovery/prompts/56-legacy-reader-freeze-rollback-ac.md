# 窗口启动器 — 56 legacyReader 冻结读端升格 rollback AC（P2）

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/56-legacy-reader-freeze-rollback-ac.md
- .scratch/architecture-recovery/issues/56-legacy-reader-freeze-rollback-ac.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/56-legacy-reader-freeze-rollback-ac-report.md

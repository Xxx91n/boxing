# 窗口启动器 — 52 新装/重置默认 sameTab（以实机为准）

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/52-url-open-mode-sametab-default.md
- .scratch/architecture-recovery/issues/52-url-open-mode-sametab-default.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/52-url-open-mode-sametab-default-report.md

# 窗口启动器 — 45 CI 数据兼容性门控：golden fixture + 迁移/回滚测试

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/45-ci-data-golden-gates.md
- .scratch/architecture-recovery/issues/45-ci-data-golden-gates.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/45-ci-data-golden-gates-report.md

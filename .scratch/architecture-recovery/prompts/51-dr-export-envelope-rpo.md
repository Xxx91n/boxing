# 窗口启动器 — 51 导出信封/完整包 + 覆盖必先副本 + RPO/RTO ADR

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/51-dr-export-envelope-rpo.md
- .scratch/architecture-recovery/issues/51-dr-export-envelope-rpo.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/51-dr-export-envelope-rpo-report.md

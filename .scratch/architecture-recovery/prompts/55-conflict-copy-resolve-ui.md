# 窗口启动器 — 55 冲突副本解决 UI（P2，实施 deferred）

身份: Boxing 子窗口实施代理，只做本票，不跨票。

## 必读（动手前全部读完）
- .scratch/architecture-recovery/handoffs/55-conflict-copy-resolve-ui.md
- .scratch/architecture-recovery/issues/55-conflict-copy-resolve-ui.md
...
## 完成时
- 遵循 handoff 内的完成定义
- 写报告: .scratch/architecture-recovery/reports/55-conflict-copy-resolve-ui-report.md

...
| A-045 | B55 merge 质量：票 80 方案未实施；子盒静默吞没（D-009 整票） | baseRevision/等价 + 子盒/id 级合并 + e2e | 禁只落方案；禁静默改 newer-wins；关联 GH #11 | implemented（票 91 · 2026-09-13：mergeLayoutThreeWay/syncBase 落地，e2e spec 落盘；F-91-CI 具名待办随 wave9 收口关闭，见 reports/91-report.md） |

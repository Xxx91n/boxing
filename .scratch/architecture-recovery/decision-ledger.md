...
| A-061 | D-002/D-004 中间 G-A 34808080000 ≠ 发行终谳；B 轨 land 后须新 tip 重跑 | 发行 G-A 绑最终 tip test.yml 四 job 全绿；等用户 G-B | 禁止用旧 run 冒充；tag/商店另令（D-007） | implemented（2026-09-14 · 发行 tip 8a8798c9 · test.yml run https://github.com/Xxx91n/boxing/actions/runs/34857433215 conclusion=success：data-golden + ubuntu + macos + windows 四 job 全绿 · docs-gov 34857433250 success · 等用户 G-B 声明 2026.9.15+日期） |

...
| A-061 | D-002/D-004 中间 G-A 34808080000 ≠ 发行终谳；B 轨 land 后须新 tip 重跑 | 发行 G-A 绑最终 tip test.yml 四 job 全绿；等用户 G-B | 禁止用旧 run 冒充；tag/商店另令（D-007） | current（收口审计 2026-09-14：B 轨 land 后待新 tip CI 发行 G-A；等用户 G-B） |

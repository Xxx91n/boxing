# Wave9.15 发行后 Backlog（呈报 · 是否立票由你裁定）

> 2026-09-14 · 源: 收口审计 + 首脑复核具名残余 + 发行后观察

| ID | 事项 | 优先级 | 建议 |
|---|---|---|---|
| B71 | N-101-06 zoom-dblclick 异源签名（L192 一次 dblclick 双建，firefox ~%） | P2 | 开票；属创建冷却族，非 fire-and-forget |
...
#10–#16 全部 closed（实施证据 + 首脑复核 + 发行 G-A）。

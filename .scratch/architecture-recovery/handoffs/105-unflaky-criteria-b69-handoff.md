# Handoff — Ticket 105: 撤账判据写入规则（B69）

> Covers: A-059 · Blocked by: 97  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/105-unflaky-criteria-b69.md`

## 一句话

将「≥2 连续 main 绿才撤 flaky 帐」等判据写入测试治理/豁免规则。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/105-unflaky-criteria-b69.md |
| Spec | spec.md |
...
3. **对标** 工业级实现/测试策略。  
调研结论写入 `reports/105-report.md` 开头，再进入实现。

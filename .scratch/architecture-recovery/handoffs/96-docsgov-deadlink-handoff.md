# Handoff — Ticket 96: docs-gov dead-link 修绿

> Covers: A-050 · Blocked by: None (can start immediately)  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/96-docsgov-deadlink.md`

## 一句话

AI Docs Governance Dead-link check 在 main 恢复 success：修 naive regex 与/或 AGENTS/CONTEXT 链接写法，不得静默删检查。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/96-docsgov-deadlink.md |
| Spec | spec.md |
...
3. **对标** 工业级实现/测试策略。  
调研结论写入 `reports/96-report.md` 开头，再进入实现。

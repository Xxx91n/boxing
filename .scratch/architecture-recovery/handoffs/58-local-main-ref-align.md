# Handoff — 58 本地 main ref 与 origin/main 对齐（P2，待授权）

## 票面
- Issue: issues/58-local-main-ref-align.md
- Spec: spec.md（Wave6 节）
- Ledger: decision-ledger.md 覆盖 A-010
- Blocked by: None (can start immediately)

## 完成定义
遵循 issues/58-local-main-ref-align.md 全部验收项 + 报告落盘。

## 版本控制
遵循 WORKFLOW §4.2（GitButler but CLI；不 push、不开 PR，除非用户明确要求）。

## 必读
1. issues/58-local-main-ref-align.md
2. spec.md（Wave6）
...
## 完成时
- 报告: reports/58-local-main-ref-align-report.md
- 报告路径必须写进本窗口最终回复

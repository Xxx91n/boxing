# Handoff — Ticket 99: locale README 14 语对齐（B63）

> Covers: A-053 · Blocked by: 97  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/99-locale-readme-b63.md`

## 一句话

各 locale README 与主 README/Release status 版本口径对齐，清除过时 store=9.11 类残留。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/99-locale-readme-b63.md |
| Spec | spec.md |
...
3. **对标** 工业级实现/测试策略。  
调研结论写入 `reports/99-report.md` 开头，再进入实现。

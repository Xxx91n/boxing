# Handoff — Ticket 101: fire-and-forget 测试族 deflake（B65）

> Covers: A-055 · Blocked by: 104  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/101-deflake-b65.md`

## 一句话

识别并降低 fire-and-forget 测试族 flaky；清单落盘；N/数据完整性不豁免。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/101-deflake-b65.md |
| Spec | spec.md |
...
3. **对标** 工业级实现/测试策略。  
调研结论写入 `reports/101-report.md` 开头，再进入实现。

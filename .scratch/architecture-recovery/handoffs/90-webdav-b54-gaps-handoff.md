# Handoff — Ticket 90: B54 WebDAV .local 与 opt-in 导出传播

> Covers: A-044 · Blocked by: None (can start immediately)  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/90-webdav-b54-gaps.md`

## 一句话

B54 WebDAV .local 与 opt-in 导出传播（2026.9.15 波）。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/90-webdav-b54-gaps.md |
| Spec | spec.md |
...
调研结论写入 `reports/90-report.md` 开头，再进入实现。

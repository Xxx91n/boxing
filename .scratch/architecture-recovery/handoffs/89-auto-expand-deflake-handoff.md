# Handoff — Ticket 89: R3 auto-expand collapseHover 去 flaky

> Covers: A-043 · Blocked by: None (can start immediately)  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/89-auto-expand-deflake.md`

## 一句话

R3 auto-expand collapseHover 去 flaky（2026.9.15 波）。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/89-auto-expand-deflake.md |
| Spec | spec.md |
...
调研结论写入 `reports/89-report.md` 开头，再进入实现。

# Handoff 82 — WebDAV 私网 opt-in

> A-xxx: A-032 · blocked: None (can start immediately)

## 身份

你是 Wave8 票 82 实施/执行窗口。
...
- .scratch/architecture-recovery/issues/82-webdav-private-optin.md

## 本票 delta

检查点: 保留 SSRF 说明。专属验收: 未 opt-in 行为与现网一致。

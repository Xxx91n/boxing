# Handoff 81 — CRED per-install key

> A-xxx: A-031 · blocked: None (can start immediately)

## 身份

你是 Wave8 票 81 实施/执行窗口。
...
- docs/CONTEXT.md
- AGENTS.md
- .scratch/architecture-recovery/issues/81-cred-per-install-key.md

## 本票 delta

检查点: 禁 passphrase 真加密重设计。专属验收: cred 相关回归绿。

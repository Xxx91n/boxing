# Handoff — Ticket 91: B55 layout/WebDAV merge 三向整票

> Covers: A-045 · Blocked by: None (can start immediately)  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/91-merge-three-way-b55.md`

## 一句话

B55 layout/WebDAV merge 三向整票（2026.9.15 波）。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/91-merge-three-way-b55.md |
| Spec | spec.md |
...
调研结论写入 `reports/91-report.md` 开头，再进入实现。

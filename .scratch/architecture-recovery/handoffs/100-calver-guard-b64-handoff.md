# Handoff — Ticket 100: calver 一致性门禁（B64）

> Covers: A-054 · Blocked by: None (can start immediately)  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/100-calver-guard-b64.md`

## 一句话

manifest/package/release-notes 等版本面一致性校验接入 pre-commit 或 CI，不一致非零退出。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/100-calver-guard-b64.md |
| Spec | spec.md |
...
3. **对标** 工业级实现/测试策略。  
调研结论写入 `reports/100-report.md` 开头，再进入实现。

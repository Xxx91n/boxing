# Handoff — Ticket 98: 冻结 hack 就地注释（锐评8）

> Covers: A-052 · Blocked by: 96, 100  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/98-frozen-comments-rui8.md`

## 一句话

ntp.js 冻结点与 i18n 重复键增加 // frozen by ticket 83/66 及报告指针，不改契约字节。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/98-frozen-comments-rui8.md |
| Spec | spec.md |
...
3. **对标** 工业级实现/测试策略。  
调研结论写入 `reports/98-report.md` 开头，再进入实现。

# Handoff 83 — 搜索 debounce

> A-xxx: A-033 · blocked: None (can start immediately)

## 身份

你是 Wave8 票 83 实施/执行窗口。
...
- .scratch/architecture-recovery/issues/83-search-debounce.md

## 本票 delta

检查点: ADR-0013 Q3=B。专属验收: 快速输入改善说明。

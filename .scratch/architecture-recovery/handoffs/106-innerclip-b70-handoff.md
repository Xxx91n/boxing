# Handoff — Ticket 106: innerclip firefox 观察结论（B70）

> Covers: A-060 · Blocked by: 101  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/106-innerclip-b70.md`

## 一句话

核查 innerclip firefox flaky 是否在 CI 复现；复现则修，否则书面观察结案。

## 必读

| 用途 | 路径 |
|---|---|
| 本票 | issues/106-innerclip-b70.md |
| Spec | spec.md |
...
3. **对标** 工业级实现/测试策略。  
调研结论写入 `reports/106-report.md` 开头，再进入实现。

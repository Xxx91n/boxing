# Handoff — Ticket 97: docs 层 live Release status（锐评6）

> Covers: A-051 · Blocked by: 100, 104  
> Spec: `.scratch/architecture-recovery/spec.md` · Issue: `issues/97-release-status-rui6.md`

## 一句话

docs/ 增加可维护发行状态页：当前版本、G-A/G-B/G-C、在效豁免/欠账；记中间里程碑与发行终谳预留。
...
3. **对标** 工业级实现/测试策略。  
调研结论写入 `reports/97-report.md` 开头，再进入实现。
